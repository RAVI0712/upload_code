...
class NewproductbasedContent extends Component {
                        ...
                        <div className="container landing-section-container">
                            <div className="row">
                                <div className="col-md-12 col-sm-12" style={{position:'relative',zIndex:'7'}}>
                                    ...
                                    <div className="home_bnr_btn">
                                        <button className="btn_option">
                                            <Link to="/new-product">Enter New Product Detail</Link>
                                        </button>
                                        <span>or</span>
                                        
                                        <button className="btn_option">
                                            <Link to="/new-product-csv-upload">Upload a CSV</Link>
                                        </button>
                                    </div>
